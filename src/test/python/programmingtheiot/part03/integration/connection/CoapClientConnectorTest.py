...
class CoapClientConnectorTest(unittest.TestCase):
	...
	def testGetActuatorCommandCon(self):
		...
		"""
		self.coapClient.sendGetRequest(resource = ResourceNameEnum.CDA_ACTUATOR_CMD_RESOURCE,
									   enableCON = True,
									   timeout = 5)
	...
	def testDeleteSensorMessageCon(self):
		...
		"""
		self.coapClient.sendDeleteRequest(resource = ResourceNameEnum.CDA_SENSOR_MSG_RESOURCE,
										  enableCON =
										  True, timeout = 5)
	...
	def testPostSensorMessageCon(self):
		...
		self.coapClient.sendPostRequest(resource = ResourceNameEnum.CDA_SENSOR_MSG_RESOURCE,
										enableCON = True,
										payload = jsonData,
										timeout = 5)
	...
	def testPutSensorMessageCon(self):
		...
		self.coapClient.sendPutRequest(resource = ResourceNameEnum.CDA_SENSOR_MSG_RESOURCE,
									   enableCON = True,
									   payload = jsonData,
									   timeout = 5)
