...
class CoParticleActuatorSimTask (BaseActuatorSimTask):
    """
    ...
    def __init__(self):
        super(CoParticleActuatorSimTask, self).__init__(name = ConfigConst.CO_PARTICLE_ACTUATOR_NAME,
                                                        typeID = ConfigConst.CO_PARTICLE_ACTUATOR_TYPE,
                                                        simpleName = "BUZZER_ALARMA")